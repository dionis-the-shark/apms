...
func scanTaskDependency(s taskDependencyScanner) (taskdependency.TaskDependency, error) {
	var td taskdependency.TaskDependency
	err := s.Scan(&td.BlockedTaskID, &td.DependentOnID)
	return td, err
}

func (r *TaskDependencyRepository) CreateTaskDependency(td taskdependency.TaskDependency) error {
...
func (r *TaskDependencyRepository) GetTaskDependency(blockedTaskID, dependentOnID uuid.UUID) (taskdependency.TaskDependency, error) {
...
func (r *TaskDependencyRepository) GetTaskDependencies() ([]taskdependency.TaskDependency, error) {
	...
	var deps []taskdependency.TaskDependency
	for rows.Next() {
...
func (r *TaskDependencyRepository) GetTaskDependenciesByBlockedTask(blockedTaskID uuid.UUID) ([]taskdependency.TaskDependency, error) {
	rows, err := r.DB.Query(
...
func (r *TaskDependencyRepository) UpdateTaskDependency(oldBlockedTaskID, oldDependentOnID, newBlockedTaskID, newDependentOnID uuid.UUID) error {
...
func (r *TaskDependencyRepository) DeleteTaskDependency(blockedTaskID, dependentOnID uuid.UUID) error {
