...
import (
	...
	"github.com/dionis-the-shark/apms-task-tracker/internal/handlers/auth"
	...
	role_handlers "github.com/dionis-the-shark/apms-task-tracker/internal/handlers/role"
...
func NewRouter(services *app.Services) nethttp.Handler {
	...
	r.Route("/auth", func(r chi.Router) {
		...
		r.Get("/validate", auth.Validate(services.Auth))
	})
	...
	r.Route("/roles", func(r chi.Router) {
		r.Post("/", role_handlers.Create(services.Roles))
		r.Get("/", role_handlers.GetAll(services.Roles))
		r.Get("/{role_id}", role_handlers.GetByID(services.Roles))
		r.Put("/{role_id}", role_handlers.Update(services.Roles))
		r.Delete("/{role_id}", role_handlers.Delete(services.Roles))
	})
